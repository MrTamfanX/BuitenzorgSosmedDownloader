...
public class IntroMediafirekasActivity extends  AppCompatActivity  { 
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.intro_mediafirekas);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_koneksi_request_listener = new RequestNetwork.RequestListener() {
			...
			public void onErrorResponse(String _param1, String _param2) {
				...
				nokoneksi.setClass(getApplicationContext(), NokoneksikasActivity.class);
	...
	private void initializeLogic() {
		...
		com.airbnb.lottie.LottieAnimationView lottieview = new com.airbnb.lottie.LottieAnimationView(IntroMediafirekasActivity.this);
		
		
		
		lottieview.setAnimation("fonts/buitenzorg_facebook.ttf");
