...
public class NoInternetkasActivity extends  AppCompatActivity  { 
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.no_internetkas);
	...
	private void initializeLogic() {
		...
		com.airbnb.lottie.LottieAnimationView lottieview = new com.airbnb.lottie.LottieAnimationView(NoInternetkasActivity.this);
