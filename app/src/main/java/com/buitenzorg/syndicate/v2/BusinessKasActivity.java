...
public class BusinessKasActivity extends  AppCompatActivity  { 
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.business_kas);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		imageview1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				final com.google.android.material.bottomsheet.BottomSheetDialog bottomSheetDialog = new com.google.android.material.bottomsheet.BottomSheetDialog(BusinessKasActivity.this);
	...
	public void _homekas () {
		FileUtil.listDir(FileUtil.getExternalStorageDir().concat("/WhatsApp Business/Media/.Statuses/"), l);
		n = 0;
