...
public class IntroInstagramActivity extends  AppCompatActivity  { 
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.intro_instagram);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_koneksi_request_listener = new RequestNetwork.RequestListener() {
				...
				time1 = new TimerTask() {
					...
					public void run() {
						runOnUiThread(new Runnable() {
							@Override
							public void run() {
								intent.setClass(getApplicationContext(), InstagramKasActivity.class);
			...
			public void onErrorResponse(String _param1, String _param2) {
				...
				nokoneksi.setClass(getApplicationContext(), NokoneksiActivity.class);
	...
	private void initializeLogic() {
		...
		com.airbnb.lottie.LottieAnimationView lottieview = new com.airbnb.lottie.LottieAnimationView(IntroInstagramActivity.this);
		
		
		
		lottieview.setAnimation("fonts/buitenzorg_instagram.ttf");
