...
public class NokoneksiActivity extends  AppCompatActivity  { 
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.nokoneksi);
	...
	private void initializeLogic() {
		...
		com.airbnb.lottie.LottieAnimationView lottieview = new com.airbnb.lottie.LottieAnimationView(NokoneksiActivity.this);
