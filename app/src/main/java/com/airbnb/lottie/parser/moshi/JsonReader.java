...
import com.airbnb.lottie.Buffer;
import com.airbnb.lottie.BufferedSink;
import com.airbnb.lottie.ByteString;
import com.airbnb.lottie.BufferedSource;
...
public abstract class JsonReader implements Closeable {
  ...
  public static final class Options {
    ...
    final com.airbnb.lottie.Options doubleQuoteSuffix;

    private Options(String[] strings, com.airbnb.lottie.Options doubleQuoteSuffix) {
     ...
     public static Options of(String... strings) {
      try {
        ...
        return new Options(strings.clone(), com.airbnb.lottie.Options.of(result));
      } catch (IOException e) {
